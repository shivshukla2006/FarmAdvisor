        ...
        messages: [
          {
            role: "system",
            content:
              "You are an expert agricultural advisor with deep knowledge of crop science, soil management, and farming practices. Provide accurate, practical recommendations.",
          },
          {
            role: "user",
            content: prompt,
